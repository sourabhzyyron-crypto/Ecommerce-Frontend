      ...
      <div className="absolute bottom-6 left-6 right-6">
        <div className="backdrop-blur-xl bg-white/90 border border-white/40 rounded-[2rem] p-7 shadow-[0_10px_40px_rgba(0,0,0,0.12)] transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_20px_60px_rgba(0,0,0,0.2)]">
          ...
          <button
            ...
            className="group flex items-center gap-2 bg-[#313447] text-white px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 hover:bg-[#7072a8]"
          >
            {buttonText}
            <ArrowUpRight
              size={16}
  ...
  const categories: CategoryProps[] = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1513094735237-8f2714d57c13?w=600&auto=format&fit=crop&q=60",
      buttonText: "Explore Now",
      badgeColor: "bg-pink-50 text-pink-600",
      categoryKey: "women-dress",
    },
    {
      ...
      discountText: "Enjoy 20% savings",
      image:
        "https://images.unsplash.com/photo-1617114919297-3c8ddb01f599?w=600&auto=format&fit=crop&q=60",
      buttonText: "Explore Now",
      badgeColor: "bg-yellow-50 text-yellow-700",
      categoryKey: "men-collections",
    },
    {
      ...
      discountText: "Enjoy 20% savings",
      image:
        "https://images.unsplash.com/photo-1596870230751-ebdfce98ec42?w=600&auto=format&fit=crop&q=60",
      buttonText: "Explore Now",
      badgeColor: "bg-teal-50 text-teal-600",
      categoryKey: "kids-collections",
    },
  ];
