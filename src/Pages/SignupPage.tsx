...
const SignUp: React.FC = () => {
 ...
 <img src="https://www.svgrepo.com/show/303108/google-icon-logo.svg" alt="Google" className="w-5 h-5" />
          ...
          <div className="text-center my-4">
            <span className="text-xs text-slate-400 bg-white px-2">Or fill out your details</span>
          </div>
            ...
            <div className="flex items-start justify-between text-xs sm:text-sm">
              <label className="flex items-start space-x-2 cursor-pointer text-slate-500">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 rounded text-purple-600 focus:ring-purple-400 border-slate-300 accent-purple-600"
                />
